...
using Consul.gRpcService.Hosting.Consul;
using Consul.gRpcService.Hosting.Consul.Entity;
using Consul.gRpcService.Impl;
...
namespace Consul.gRpcService.Hosting
{
